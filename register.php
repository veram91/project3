<?php
	...
	if(!empty($_POST['submitted'])){
		...
		$redirect="Location:index.php?customer_ID=".$row[0];
		header($redirect);
		exit;
		}
	}
...
<body>
	...
	<input class="floaty" type='hidden' name='submitted' id='submitted' value='1'/>
	<label for='fname' >First Name*: </label>
	<input class="floaty" type='text' name='fname' id='fname' maxlength="50" required/><br/>
	<label for='lname' >Last Name*: </label>
	<input class="floaty" type='text' name='lname' id='lname' maxlength="50" required/><br/>
	<label for='email' >Email*: </label>
	<input class="floaty" type='text' name='email' id='email' maxlength="50" required /><br/>
	<label for='pass' >Password*: </label>
	<input class="floaty" type='password' name='pass' id='pass' maxlength="50" required/><br/>
	<label> Stay logged in?: </label>
	<input class="floaty" type="checkbox" name="persist"></input><br/>
	<input class="floaty" type='submit' name='submit' value='Register' />
